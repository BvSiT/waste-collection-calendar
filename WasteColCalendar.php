...
class WasteColCalendar{
	...
	* 'DGB' => array(
    *     'waste_type_name' =>'Bac vert fonc�',
		*			'waste_type_info'=>'Ordures m�nag�res',
    *     'sector_name' => null,
    *     'sector_PM' => null,
    *     'sector_weekday' => null,
...
*/
	...
	public function format_col_dates($waste_type_code,$locale='fr_FR',$days_bold=true){
		...
		* I.e. '1 et 10 janv. - 5, 15, 25 f�vr.' etc.
		*
	...
	*/
	...
	public function format_coming_col_events($from=null){
		...
		*							 array('waste_type_name')=>'Bac vert fonc�'),
		*							 'waste_type_info'=>'Ordures m�nag�res',
		*       'YEB'=>...etc.
		* );
		*
